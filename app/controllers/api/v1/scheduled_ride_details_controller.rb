class Api::V1::ScheduledRideDetailsController < ApiController
    ...
    if numtos.nil?
      render json: {result: "Sorry, you need to sign in first"}
       ...
       # params needed to create order
        ...
        # }
        # " 
      ScheduledRideDetail.create(order_params)
  ...
  def update
    ...
    if numtos.nil?
      ...
      @sheduled_ride.update(order_params)
  ...
  def set_order
    @sheduled_ride = ScheduledRideDetail.find(params[:id])
  end

  def order_params
    params.require(:scheduled_ride_details).permit!
  end
